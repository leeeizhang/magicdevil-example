...
public abstract class SpringAbstractService<K, V extends IEntity, D extends IDAO<K, V>>
        extends AbstractService<K, V, D> {
    ...
    @Override
    public List<V> getAllBySpilt(int pageSize, int currentPage) throws Exception {
